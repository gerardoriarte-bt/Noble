  ...
  return (
    <footer className="bg-stone border-t border-noir/10 py-16">
        ...
        <div className="md:col-span-2 grid grid-cols-2 gap-8">
            <div>
                ...
                <ul className="space-y-3 text-sm text-noir/70">
                    <li><a href="/" className="hover:text-noir transition-colors">Home</a></li>
                    <li><a href="/about" className="hover:text-noir transition-colors">About</a></li>
                    <li><a href="/#portfolio" className="hover:text-noir transition-colors">Portfolio</a></li>
                    <li><a href="/#contact" className="hover:text-noir transition-colors">Contact</a></li>
                </ul>
            </div>
             <div>
      ...
      <div className="container mx-auto px-6 mt-16 border-t border-noir/10 pt-8 text-center">
        <p className="text-xs text-noir/50 tracking-wider">&copy; {new Date().getFullYear()} Noble Architecture Studio. All Rights Reserved.</p>
      </div>
    </footer>
  );
};
