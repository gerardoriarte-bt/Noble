...
const Contact: React.FC = () => {
    return (
        <section id="contact" className="py-32 md:py-48 bg-noir text-cloud">
            <div className="container mx-auto px-6 text-center flex flex-col items-center">
                ...
                >
                    ...
                    <motion.p 
                        className="mt-8 mb-12 text-lg text-cloud/70 max-w-xl mx-auto"
                        variants={{ hidden: { opacity: 0, y: 40 }, visible: { opacity: 1, y: 0 } }}
                    >
                    ...
                    <motion.a
                        ...
                        className="text-2xl md:text-3xl font-serif text-cloud relative w-fit group"
                        variants={{ hidden: { opacity: 0, y: 40 }, visible: { opacity: 1, y: 0 } }}
                    >
                        <span>
                            studio@noble.com
