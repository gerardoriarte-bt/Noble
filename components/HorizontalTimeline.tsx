...
import { projects as timelineData, type Project as TimelineItem } from '../data/projects';
            ...
            >
              ...
              <div className="flex-1 flex flex-col" style={{ minHeight: 0 }}>
                ...
                >
                  ...
                  >
                    <a
                      href={`/proyecto/${item.slug}`}
                      onClick={(e) => {
                        // Cmd/Ctrl-clic abre la página del proyecto en otra pestaña
                        if (e.metaKey || e.ctrlKey || e.shiftKey) return;
                        e.preventDefault();
                        handleOpenModal(item);
                      }}
                      className="block text-center w-full py-3 px-4 border-2 border-noir/50 hover:border-noir bg-noir/15 hover:bg-noir/25 text-noir font-medium transition-all duration-300 text-sm uppercase tracking-widest shadow-md"
                      style={{ 
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <a
                      ...
                      className="block text-center w-full py-3 px-4 border-2 border-noir/30 hover:border-noir bg-noir/5 hover:bg-noir/10 text-noir transition-all duration-300 text-sm uppercase tracking-widest font-light"
                    >
                      Ver Detalles
                    </a>
                  </div>
